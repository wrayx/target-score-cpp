...
int main(int argc, char const *argv[])
{
    ...
    ShootingScore *ss = new ShootingScore("../input_images/group_1/aligned/aligned_shot_0.JPG", "../input_images/group_1/aligned/aligned_shot_1.JPG", "../input_images/group_1/aligned/aligned_shot_0.JPG");
